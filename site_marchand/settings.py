"""
Django settings for site_marchand project.
...
SECRET_KEY = ')@+nmv9iwe5otk$ieo81ib@nxip#bug@3g@x4pgb71_9wdmuym'
...
ROOT_URLCONF = 'site_marchand.urls'
...
WSGI_APPLICATION = 'site_marchand.wsgi.application'
